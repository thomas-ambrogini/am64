...
Configurer::Configurer(CommunicationType commType, const Endpoint &endpoint, const Logger &l) : Configurer(commType, endpoint, l, "../conf/configFile.json", false)
{
}
...
void Configurer::initCommunication()
{
    ...
    else if (communicationType == CommunicationType::RPMessage)
    {
        ...
        logger.log("Waiting for the Init message from the linux configurer");
