...
void TopicHandler::printHandledTopic()
{
...
void TopicHandler::print(Record record)
{
    TopicMetadata printMetadata("Prints");
    save(record, printMetadata, ProducerMetadata(-1));
}
